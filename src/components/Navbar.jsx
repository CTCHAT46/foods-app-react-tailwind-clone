...
import { AiOutlineClose, AiOutlineMenu, AiOutlineSearch, AiFillHeart, AiFillTag } from 'react-icons/ai'
import { BsFillCartCheckFill } from 'react-icons/bs'
import { MdHelp } from 'react-icons/md'
import { FaWallet, FaTruck, FaUserFriends, FaCloudDownloadAlt } from 'react-icons/fa'
        ...
        <div className='max=w=[1640px] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
                    BEST EATS<span className='font-bold'> CT CHAT</span>
                </h1>
            ...
            <button className='bg-black text-white hidden md:flex items-center py-2 rounded-full'>
                <BsFillCartCheckFill size={20} className='mer-2' />Cart
            </button>
